...
% also implement economic MPC using linear plant models.
 ...
 nlobj.Model.StateFcn = 'aircraft_dynamics_linear';
 nlobj.Model.IsContinuousTime = true;

%% INITIAL CONDITIONS SWITCHING
Nmv = 4;  Nx = 16;

% --- YOUR IC vectors (column) ---
u_to = [295140, 319450, 4.163, 6.075].';
u_cr = [ 69980, 300000, 5.4805, 7.150].';
u_ld = [ 69980, 178835, 4.135, 8.552].';

x_to = [20275100030210626643675627/393605954186145082200000; 2979945209973437579603/61414566107995800000; 0.95; 19353199461943751447675627/393605954186145082200000; 3002556108225437579603/61414566107995800000; 1; 21715964372172979203125627/393605954186145082200000; 3222032306869374239603/61414566107995800000; 1; 657622429946024881/14752478046600000; 1; 37742600191627471661144839/614944050439361945400000; 3590589948376974239603/61414566107995800000; 657622429946024881/14752478046600000; 81610506679008893/1844059755825000; 9032287404091/204611346000];   % (you already have them)
x_cr = [52814776030872794621339/2111078349043945281000; 104094200346052350023/4282106184673317000; 0.95; 7429519190417529794477/301582621291992183000; 14970426814841764289/611729454953331000; 1; 62413813461003262061339/2111078349043945281000; 115709353125739950023/4282106184673317000; 1; 1317031521595249/55809639171000; 1; 192210910256741628225757/6125247032447703303000; 18157083865504564289/611729454953331000; 1317031521595249/55809639171000; 29037669531913/1240214203800; 1405698391771/60204573000];
x_ld = [93988057444394599308387229/4422589792359066198000000; 14175896344014406900981/690059259222822000000; 0.95; 642296550198010131218710603/30958128546513463386000000; 99794188918686328306867/4830414814559754000000; 1; 748871653711516104483208603/30958128546513463386000000; 109523475430206270118867/4830414814559754000000; 1; 114489338227757388521/5840888530302000000; 1; 1232797079008717771442215271/48366943538186816802000000; 118698981952749594118867/4830414814559754000000; 114489338227757388521/5840888530302000000; 1053909433374709813/54082301206500000; 8752431102689/450060759000];

% --- Build numeric matrices first ---
U0_mat = [u_to, u_cr, u_ld];          % 4x3
X0_mat = [x_to, x_cr, x_ld];          % 16x3

% --- Sanity checks on numeric values ---
assert(isequal(size(U0_mat),[Nmv 3]), 'U0 must be 4x3');
assert(isequal(size(X0_mat),[Nx  3]), 'X0 must be 16x3');

% --- (Optional) wrap as Simulink parameters AFTER checks ---
U0 = Simulink.Parameter(U0_mat); U0.CoderInfo.StorageClass = 'Auto';
X0 = Simulink.Parameter(X0_mat); X0.CoderInfo.StorageClass = 'Auto';

 %Takeoff
 %x0 = [20275100030210626643675627/393605954186145082200000; 2979945209973437579603/61414566107995800000; 0.95; 19353199461943751447675627/393605954186145082200000; 3002556108225437579603/61414566107995800000; 21715964372172979203125627/393605954186145082200000; 3222032306869374239603/61414566107995800000; 657622429946024881/14752478046600000; 37742600191627471661144839/614944050439361945400000; 3590589948376974239603/61414566107995800000; 657622429946024881/14752478046600000; 81610506679008893/1844059755825000; 9032287404091/204611346000];
 %u0 = [295140, 319450, 4.163, 6.075];
 %cruise
...
%% --- Mode schedule (time → mode), published as a timeseries for the Parameters port ---
% Exact phase boundaries you specified:
t_takeoff_end = 421.700;    % s
t_cruise_end  = 3658.001;   % s
t_final       = 4498.599;   % s

% Controller tick times
tgrid = (0:Ts:t_final).';   % [0, Ts, 2Ts, ..., t_final]
mode_vals = ones(size(tgrid), 'int32');           % default TAKEOFF (=1)
mode_vals(tgrid >= t_takeoff_end) = int32(2);     % CRUISE (=2)
mode_vals(tgrid >= t_cruise_end)  = int32(3);     % LANDING (=3)

% Pack as timeseries for your existing From Workspace → Parameters wire
mode_ts = timeseries(mode_vals, tgrid);
assignin('base','mode_ts', mode_ts);

%% Simulink Model with Economic MPC Controller
% Open the Simulink model.
mdl = 'linear_controller_nonlinear_plant_mks_sim';
open_system(mdl)
